        ...
        <div id="contact" className="contact">
            ...
            <div className="contact-contaner">
                <div className="contact-n phone">
                    ...
                    <a href="tel:+27716490290" target="_blank">
                ...
                <div className="contact-n email">
                    <a href="mailto:sethobjakoketjo90@gmail.com" target="_blank">
                ...
                <div className="contact-n linkedin">
                    <a href="https://www.linkedin.com/in/koketjo-sethobja-22498a162/" target="_blank">
                ...
                <div className="contact-n github">
                    <a href="https://github.com/KoketjoSethobja" target="_blank">
                ...
                <div className="contact-n facebook">
                    <a href="https://www.facebook.com/koketjo.sethobja.14" target="_blank">
                ...
                <div className="contact-n whatsapp">
                    <a href="https://wa.me/27716490290"target="_blank">
                ...
                <div className="contact-n twitter">
                    <a href="https://twitter.com/SKoketjo" target="_blank">
